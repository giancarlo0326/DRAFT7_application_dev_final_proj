        ...
        <div class="row">
          <div class="col-md-3">
            <div class="card">
              ...
              <div class="card-body">
              <p class="card-text">Adia, Paulo Lorenzo</p>
          ...
          <div class="col-md-3">
            <div class="card">
              <img src="https://i.pinimg.com/474x/4e/79/73/4e7973bf3a86dc66138d09db96b3cc9a.jpg" class="img-fluid">
              <div class="card-body">
              <p class="card-text">Carls, Kyle Philippe</p>
              <p class="card-text">Back-end Developer</p>
              </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="card">
              <img src="https://i.pinimg.com/474x/4e/79/73/4e7973bf3a86dc66138d09db96b3cc9a.jpg" class="img-fluid">
              <div class="card-body">
                <p class="card-text">Valerio, Gabriel Eduard</p>
                <p class="card-text">Back-end Developer</p>
              </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="card">
              <img src="https://i.pinimg.com/474x/4e/79/73/4e7973bf3a86dc66138d09db96b3cc9a.jpg" class="img-fluid">
              <div class="card-body">
                <p class="card-text">Victorino, Gian Carlo</p>
